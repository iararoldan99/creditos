...
//una entidad es un objeto de persistencia, hace referencia a los objetos creados por nosotras
//una entidad representa una tabla en una base de datos, 
//y cada instancia de entidad corresponde a una fila en la tabla.
